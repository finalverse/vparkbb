...
$lang = array_merge($lang, array(
	'TERMS_OF_USE_CONTENT'	=> '访问 “%1$s” （以下简称“我们”或“%1$s”）即表示您同意遵守以下条款。若您不同意，请停止访问或使用本网站。我们可能不时更新本条款，更新后您继续使用即视为接受更新后的条款。<br>
	<br>
	您不得发布任何违法、侮辱、诽谤、仇恨、骚扰、暴力、色情或其他可能违反适用法律法规的内容。我们有权在不另行通知的情况下，对相关内容采取删除、编辑、移动、锁定主题、限制账号等管理措施。<br>
	<br>
	为维护社区安全与秩序，我们会记录与发帖相关的必要技术信息（如 IP 地址与时间）。如法律法规要求，或为保护社区与用户权益，我们可能依法配合提供必要信息。<br>
	<br>
	您提交的内容版权归原作者所有；您授权 “%1$s” 在论坛范围内进行展示、存档与合理管理。若您认为内容侵权或违规，请通过“联系我们”渠道提交说明，我们将按流程处理。
	',

	'PRIVACY_POLICY'		=> '本隐私政策说明 “%1$s” （以下简称“我们”）如何收集、使用和保护您的信息。<br>
	<br>
	我们会在您注册和使用论坛时收集必要信息，例如用户名、密码哈希、邮箱地址、发帖内容、站内操作日志及与安全相关的技术信息（如 IP 地址、设备与浏览器信息）。<br>
	<br>
	我们使用 Cookie 与会话数据以维持登录状态、保存偏好设置、记录已读主题并提升使用体验。您可以在浏览器中管理 Cookie，但禁用后部分功能可能无法正常使用。<br>
	<br>
	我们仅在提供论坛服务、账号安全、内容审核、反垃圾与统计分析所必需的范围内使用您的信息。除法律法规要求、执法协助或保护社区与用户合法权益外，我们不会向无关第三方出售或披露您的个人信息。<br>
	<br>
	您可以在用户控制面板中修改部分个人资料；如需申请账号注销或数据处理协助，请通过“联系我们”与管理员联系。我们将根据适用法律与运营需要保留必要数据。
	',
));
