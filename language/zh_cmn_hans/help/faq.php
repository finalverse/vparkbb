...
$lang = array_merge($lang, array(
	...
	'HELP_FAQ_BOOKMARKS_DIFFERENCE_ANSWER'	=> '维园网里面，收藏更像订阅了一个主题，当您收藏的主题有更新的时候，您会收到通知。订阅，当主题或者版面有更新的时候，会通知您。 收藏和订阅的通知选项可以在用户控制面板里找到。',
	...
	'HELP_FAQ_ISSUES_FEATURE_ANSWER'	=> '本软件由维园网编写和授权，如果您认为某个功能需要被添加，请访问 <a href="https://www.victoriapark.io/">VictoriaPark Ideas Centre</a>，在这里您可以投票或建议新功能。',
	...
	'HELP_FAQ_ISSUES_WHOIS_PHPBB_ANSWER'	=> '这份软件(官方发行的版本)由开源软件制作，发布并持有版权。遵循 GNU General Public License, version 2 (GPL-2.0) 开源协议，可以自由发布',
	...
	'HELP_FAQ_LOGIN_COPPA_ANSWER'	=> 'COPPA，是儿童在线隐私和保护条例的缩写，生效于1998年的美国法律。这项法律要求任何有可能收集年龄小于13周岁的未成年人信息的网站必须持有其监护人的同意书，或者其他形式的合法依据才能收集其身份信息。如果您不能确认此法律是否对您的行为有约束，请联络就近的律师以得到帮助。请注意维园网并不会提供任何法律建议，也不为各种法律事件提供观点和帮助，除非以下列出的情形：“对于论坛上诽谤，脏话和其他触及法律的事务，我该联络谁？”	',
	'HELP_FAQ_LOGIN_COPPA_QUESTION'	=> '什么是 COPPA？',
	'HELP_FAQ_LOGIN_DELETE_COOKIES_ANSWER'	=> '“删除 cookies”删除了维园网论坛程序所创建的 cookies，这些 cookie 包含您在论坛上的认证信息和您在论坛上的活动记录等信息。如果论坛管理员启用阅读记录，也会被记录在 cookie 中。如果您有登录的问题，删除论坛 cookies 也许可以帮到您。',
	...
	'HELP_FAQ_POSTING_WARNING_ANSWER'	=> '每个论坛管理员对自己的论坛都有一套规则。如果他们觉得您在版面违反了规定，他们可能会对您发出一个警告。请注意这是论坛管理人员的决定。',
	...
	'HELP_FAQ_SEARCH_NO_RESULT_ANSWER'	=> '您的搜索条件可能太模糊，包含了许多常用的字词，这些字词并未被维园网索引。您可以输入更确切的关键字和更多的限制条件通过高级搜索进行查找。',
