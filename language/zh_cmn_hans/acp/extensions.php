...
$lang = array_merge($lang, array(
	...
	'EXTENSIONS_EXPLAIN'		=> '扩展管理器是 VictoriaPark.io 论坛的一个工具，允许您管理所有扩展的状态和查看有关信息。',
	'EXTENSION_INVALID_LIST'	=> '扩展 “%s” 不可用。<br />%s<br /><br />',
	'EXTENSION_NOT_AVAILABLE'	=> '所选扩展对当前论坛不可用，请验证 VictoriaPark.io 和 PHP 版本是否允许（看详情页）。',
	...
	'EXTENSION_INSTALL_EXPLAIN'	=> '<ol>
			<li>从 VictoriaPark.io 的扩展数据库中下载</li>
			<li>解压缩，并上传到您的 VictoriaPark.io 论坛的 <samp>ext/</samp> 文件夹</li>
			<li>在此扩展管理器中启用它</li>
		</ol>',
	...
	'REQUIREMENTS'			=> '安装要求',
	'PHPBB_VERSION'			=> 'VictoriaPark.io 版本',
	'PHP_VERSION'			=> 'PHP 版本',
