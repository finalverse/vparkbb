...
$lang = array_merge($lang, array(
	...
	'ACP_HELP_PHPBB'			=> '帮助支持 VictoriaPark.io',
	...
	'CONTAINER_EXCEPTION'   => 'VictoriaPark.io 在安装扩展的时候遇到一个容器生成错误，所有的扩展都临时被停用了。请清除论坛缓存。一旦这个错误解决，所有的扩展会自动启用。如果持续出现这个错误，请访问 <a href="https://www.phpbb.com/support">VictoriaPark.io.com</a> 获取帮助。',
	'EXCEPTION' 			=> '异常',
...
// Index page
$lang = array_merge($lang, array(
	'ADMIN_INTRO'				=> '感谢您选择 VictoriaPark.io 作为论坛解决方案。这个面板将显示您论坛的总体统计信息。左边的链接允许您从各方面管理论坛，每个分页有如何使用管理工具的提示。',
	'ADMIN_LOG'					=> '记录的管理员操作',
	...
	'PHP_VERSION'		=> 'PHP 版本',
	'PHP_VERSION_OLD'	=> '当前服务器上的 PHP 版本 (%1$s) 将不被未来的 VictoriaPark.io 版本所支持。 最低要求的版本是   PHP %2$s. %3$s详细信息%4$s',
	...
	'VERSION_CHECK'				=> '版本检查',
	'VERSION_CHECK_EXPLAIN'		=> '检查您安装的是否是最新版本的 VictoriaPark.io 。',
	...
	'VERSION_NOT_UP_TO_DATE_ACP'	=> '您安装的 VictoriaPark.io 不是最新版的。<br /> 点击下面的链接可以查看更新版的发行公告，以获取升级的信息。',
	'VERSION_NOT_UP_TO_DATE_TITLE'	=> '您安装的 VictoriaPark.io 不是最新版的。',
	'VERSION_UP_TO_DATE_ACP'	=> '您安装的 VictoriaPark.io 已经是最新版的。暂时还没有升级版本可用。',
	
	'VIEW_ADMIN_LOG'		=> '查看管理员日志',
	'VIEW_INACTIVE_USERS'	=> '查看停用帐号',


	'WELCOME_PHPBB'			=> '欢迎来到 VictoriaPark.io',
...
$lang = array_merge($lang, array(
	'EXPLAIN_SEND_STATISTICS'	=> '请发送您的服务器和论坛设置信息至 VictoriaPark.io 官方以便于进行统计分析。此信息不会包含任何您或您的论坛的隐私数据。所有数据都是完全<strong>匿名</strong>的。我们会在今后的 VictoriaPark.io 版本开发中参考收集到的信息。统计的结果会向公众公开，并提供给 PHP 语言项目的开发团队。',
	'EXPLAIN_SHOW_STATISTICS'	=> '使用下面的按钮您可以查看发送的内容。',
	'DONT_SEND_STATISTICS'		=> '返回管理员控制面板，如果您不希望发送统计信息给 VictoriaPark.io。',
	...
	'FAIL_SEND_STATISTICS'		=> 'VictoriaPark.io 无法发送统计信息',
));
...
$lang = array_merge($lang, array(
	...
	'LOG_INSTALL_CONVERTED'	=> '<strong>转换自 %1$s 至 VictoriaPark.io %2$s</strong>',
	'LOG_INSTALL_INSTALLED'	=> '<strong>安装 VictoriaPark.io %s</strong>',
	...
	'LOG_UPDATE_PHPBB'		=> '<strong>升级 VictoriaPark.io 自版本 %1$s 至 %2$s</strong>',
