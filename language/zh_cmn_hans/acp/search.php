...
$lang = array_merge($lang, array(
	...
	'FULLTEXT_SPHINX_WRONG_DATABASE'		=> 'Sphinx 搜索 VictoriaPark.io 只支持 MySQL 和 PostgreSQL。',
  ...
  'MAX_NUM_SEARCH_KEYWORDS_EXPLAIN'      => '用于限制用户用于搜索的关键词的个数。填写 0 则不作限制。',
	...
	'SEARCH_TYPE'							=> '搜索后端',
	'SEARCH_TYPE_EXPLAIN'					=> 'VictoriaPark.io 允许您选择用于全文检索的后端类型。默认后端是 VictoriaPark.io 自带的全文检索。',
