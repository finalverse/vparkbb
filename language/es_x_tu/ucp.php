...
$lang = array_merge($lang, array(
	'TERMS_OF_USE_CONTENT'	=> 'Al acceder a “%1$s” (en adelante “nosotros”, “nuestro”, “%1$s”, “%2$s”), usted acepta estar legalmente obligado por los siguientes términos. Si no está de acuerdo, no acceda ni use “%1$s”. Podemos actualizar estos términos en cualquier momento; su uso continuado de “%1$s” después de las actualizaciones significa que acepta los términos actualizados.
	<br><br>
	Usted acepta no publicar contenido abusivo, obsceno, difamatorio, odioso, amenazante, acosador, sexualmente explícito, ilegal o de otro modo contrario a la ley. Nos reservamos el derecho de moderar el contenido y las cuentas a nuestra discreción, incluyendo editar, mover, bloquear, ocultar o eliminar contenido, y restringir el acceso cuando sea necesario para proteger la comunidad.
	<br><br>
	Con fines de seguridad, prevención de abusos y cumplimiento, podemos registrar metadatos técnicos relacionados con su actividad, incluyendo dirección IP y marcas de tiempo. Podemos divulgar información cuando lo exija la ley aplicable o cuando sea necesario para proteger los derechos legítimos y la seguridad de la comunidad.
	<br><br>
	Usted conserva la propiedad del contenido que envía. Al publicar en “%1$s”, nos otorga un derecho no exclusivo para mostrar, almacenar y gestionar ese contenido dentro del servicio del foro. Si cree que algún contenido viola sus derechos, contáctenos a través del canal de soporte proporcionado.
	',

	'PRIVACY_POLICY'		=> 'Esta política explica cómo “%1$s” recopila, utiliza y protege su información.
	<br><br>
	Recopilamos la información necesaria para operar el foro, incluyendo datos de cuenta (nombre de usuario, hash de contraseña y correo electrónico), contenido que envía, registros de moderación y seguridad, y metadatos técnicos (dirección IP, dispositivo e información del navegador).
	<br><br>
	Utilizamos cookies y datos de sesión para mantener el estado de inicio de sesión, recordar preferencias, rastrear el estado de lectura y mejorar la experiencia del sitio. Puede gestionar las cookies en la configuración de su navegador, pero deshabilitarlas puede afectar algunas funciones.
	<br><br>
	Utilizamos su información para la gestión de cuentas, operaciones del foro, moderación, prevención de abusos y análisis del servicio. No vendemos datos personales a terceros no relacionados. Podemos divulgar datos cuando lo exija la ley o para proteger los derechos, la propiedad y la seguridad de la comunidad.
	<br><br>
	Puede actualizar partes de su perfil en el Panel de Control del Usuario. Para la eliminación de cuentas o solicitudes relacionadas con la privacidad, contacte a los administradores a través del canal de contacto. Conservamos los datos necesarios según lo requiera la ley aplicable y las necesidades operativas.
	',
));
