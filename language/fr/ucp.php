...
$lang = array_merge($lang, [
		'TERMS_OF_USE_CONTENT' => 'En accédant à « %1$s » (désigné ci-après par « nous », « notre », « %1$s » et « %2$s »), vous acceptez d’être légalement lié par les conditions suivantes. Si vous n’acceptez pas ces conditions, veuillez ne pas utiliser ni accéder à « %1$s ». Nous pouvons modifier ces conditions à tout moment ; votre utilisation continue de « %1$s » après modification signifie que vous acceptez les conditions mises à jour.
	<br><br>
	Vous acceptez de ne publier aucun contenu abusif, obscène, diffamatoire, haineux, menaçant, harcelant, sexuellement explicite, illégal ou contraire à la loi. Nous nous réservons le droit de modérer le contenu et les comptes à notre discrétion, y compris la suppression, la modification, le déplacement, le verrouillage ou la dissimulation de contenu, ainsi que la restriction de l’accès si nécessaire pour protéger la communauté.
	<br><br>
	À des fins de sécurité et de prévention des abus, nous pouvons enregistrer les métadonnées techniques liées à votre activité, y compris l’adresse IP et les horodatages. Nous pouvons divulguer des informations lorsque la loi applicable l’exige ou lorsque cela est nécessaire pour protéger les droits légitimes et la sécurité de la communauté.
	<br><br>
	Vous conservez la propriété du contenu que vous soumettez. En publiant sur « %1$s », vous nous accordez un droit non exclusif d’afficher, stocker et gérer ce contenu dans le cadre du service du forum. Si vous pensez qu’un contenu viole vos droits, contactez-nous via le canal de support prévu.
	',

	'PRIVACY_POLICY' => 'Cette politique explique comment « %1$s » collecte, utilise et protège vos informations.
	<br><br>
	Nous collectons les informations nécessaires au fonctionnement du forum, notamment les données de compte (nom d’utilisateur, hash de mot de passe, adresse e-mail), le contenu que vous soumettez, les journaux de modération et de sécurité, ainsi que les métadonnées techniques (adresse IP, appareil et navigateur).
	<br><br>
	Nous utilisons des cookies et des données de session pour maintenir l’état de connexion, mémoriser les préférences, suivre l’état de lecture et améliorer l’expérience du site. Vous pouvez gérer les cookies dans les paramètres de votre navigateur, mais la désactivation des cookies peut affecter certaines fonctionnalités.
	<br><br>
	Nous utilisons vos informations pour la gestion des comptes, les opérations du forum, la modération, la prévention des abus et l’analyse du service. Nous ne vendons pas de données personnelles à des tiers non liés. Nous pouvons divulguer des données lorsque la loi l’exige ou pour protéger les droits, la propriété et la sécurité de la communauté.
	<br><br>
	Vous pouvez mettre à jour certaines parties de votre profil dans le Panneau de contrôle de l’utilisateur. Pour la suppression de compte ou les demandes liées à la confidentialité, contactez les administrateurs via le canal de contact. Nous conservons les données nécessaires conformément à la loi applicable et aux besoins opérationnels.
	',
]);
