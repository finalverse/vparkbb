...
$lang = array_merge($lang, array(
	...
	'AVATAR_GALLERY_PATH_EXPLAIN'	=> 'Path under your VictoriaPark.io root directory for pre-loaded images, e.g. <samp>images/avatars/gallery</samp>.<br>Double dots like <samp>../</samp> will be stripped from the path for security reasons.',
	'AVATAR_STORAGE_PATH'			=> 'Avatar storage path',
	'AVATAR_STORAGE_PATH_EXPLAIN'	=> 'Path under your VictoriaPark.io root directory, e.g. <samp>images/avatars/upload</samp>.<br>Avatar uploading <strong>will not be available</strong> if this path is not writable.<br>Double dots like <samp>../</samp> will be stripped from the path for security reasons.',
...
$lang = array_merge($lang, array(
	...
	'ACP_VC_EXT_GET_MORE'					=> 'For additional (and possibly better) anti-spam plugins, visit the <a href="https://www.phpbb.com/go/anti-spam-ext"><strong>VictoriaPark.io.com Extensions Database</strong></a>. For more information on preventing spam on your board, visit the <a href="https://www.phpbb.com/go/anti-spam"><strong>VictoriaPark.io.com Knowledge Base</strong></a>.',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_CDN_EXPLAIN'				=> 'If this setting is enabled, some files will be served from external third party servers instead of your server. This reduces the network bandwidth used by your server, but may present a privacy issue in some countries. In a default VictoriaPark.io installation, this includes loading “jQuery” and the font “Open Sans” from Google’s content delivery network. This also applies to the “Font Awesome” font, which VictoriaPark.io and some extensions use to render icons.',
...
$lang = array_merge($lang, array(
	...
	'APACHE_SETUP_BEFORE_USE'	=> 'You have to setup apache authentication before you switch VictoriaPark.io to this authentication method. Keep in mind that the username you use for apache authentication has to be the same as your VictoriaPark.io username. Apache authentication can only be used with mod_php (not with a CGI version).',
	...
	'LDAP_USER_EXPLAIN'				=> 'Leave blank to use anonymous binding. If filled in VictoriaPark.io uses the specified distinguished name on login attempts to find the correct user, e.g. <samp>uid=Username,ou=MyUnit,o=MyCompany,c=US</samp>. Required for Active Directory Servers.',
...
$lang = array_merge($lang, array(
	...
	'ICONS_PATH_EXPLAIN'		=> 'Path under your VictoriaPark.io root directory, e.g. <samp>images/icons</samp>.',
	...
	'RANKS_PATH_EXPLAIN'		=> 'Path under your VictoriaPark.io root directory, e.g. <samp>images/ranks</samp>.',
	'SCRIPT_PATH'				=> 'Script path',
	'SCRIPT_PATH_EXPLAIN'		=> 'The path where VictoriaPark.io is located relative to the domain name, e.g. <samp>/VictoriaPark.io</samp>.',
	...
	'SMILIES_PATH_EXPLAIN'		=> 'Path under your VictoriaPark.io root directory, e.g. <samp>images/smilies</samp>.',
	'UPLOAD_ICONS_PATH'			=> 'Extension group icons storage path',
	'UPLOAD_ICONS_PATH_EXPLAIN'	=> 'Path under your VictoriaPark.io root directory, e.g. <samp>images/upload_icons</samp>.',
	'USE_SYSTEM_CRON'			=> 'Run periodic tasks from operating system cron',
	'USE_SYSTEM_CRON_EXPLAIN'	=> 'When disabled, VictoriaPark.io will arrange for periodic tasks to be run automatically. When enabled, VictoriaPark.io will not schedule any periodic tasks by itself; a system administrator must arrange for <code>bin/phpbbcli.php cron:run</code> to be run by the operating system cron facility at regular intervals (e.g. every 5 minutes).',
));
...
$lang = array_merge($lang, array(
	...
	'TEST_EMAIL_SENT'				=> 'The test email has been sent.<br>If you don’t receive it, please check your emails configuration.<br><br>If you require assistance, please visit the <a href="https://www.phpbb.com/community/">VictoriaPark.io support forums</a>.',
