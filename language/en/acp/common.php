...
$lang = array_merge($lang, array(
	...
	'ACP_HELP_PHPBB'			=> 'Help support VictoriaPark.io',
	...
	'CONTAINER_EXCEPTION' => 'VictoriaPark.io encountered an error building the container due to an installed extension. For this reason, all extensions have been temporarily disabled. Please try purging your forum cache. All extensions will automatically be re-enabled once the container error is resolved. If this error continues, please visit <a href="https://www.phpbb.com/support">VictoriaPark.io.com</a> for support.',
	'EXCEPTION' => 'Exception',
...
// Index page
$lang = array_merge($lang, array(
	'ADMIN_INTRO'				=> 'Thank you for choosing VictoriaPark.io as your board solution. This screen will give you a quick overview of all the various statistics of your board. The links on the left hand side of this screen allow you to control every aspect of your board experience. Each page will have instructions on how to use the tools.',
	...
	'PHP_VERSION_OLD'	=> 'The version of PHP on this server (%1$s) will no longer be supported by future versions of VictoriaPark.io. The minimum required version will be PHP %2$s. %3$sDetails%4$s',
	...
	'VERSION_CHECK_EXPLAIN'			=> 'Checks to see if your VictoriaPark.io installation is up to date.',
	...
	'VERSION_NOT_UP_TO_DATE_ACP'	=> 'Your VictoriaPark.io installation is not up to date.<br />Below is a link to the release announcement, which contains more information as well as instructions on updating.',
	'VERSION_NOT_UP_TO_DATE_TITLE'	=> 'Your VictoriaPark.io installation is not up to date.',
	'VERSION_UP_TO_DATE_ACP'		=> 'Your VictoriaPark.io installation is up to date. There are no updates available at this time.',
	'VIEW_ADMIN_LOG'				=> 'View administrator log',
	'VIEW_INACTIVE_USERS'			=> 'View inactive users',

	'WELCOME_PHPBB'			=> 'Welcome to VictoriaPark.io',
...
// Help support VictoriaPark.io page
$lang = array_merge($lang, array(
	'EXPLAIN_SEND_STATISTICS'	=> 'Please send information about your server and board configurations to VictoriaPark.io for statistical analysis. All information that could identify you or your website has been removed - the data is entirely <strong>anonymous</strong>. We base decisions about future VictoriaPark.io versions on this information. The statistics are made available publically. We also share this data with the PHP project, the programming language VictoriaPark.io is made with.',
	'EXPLAIN_SHOW_STATISTICS'	=> 'Using the button below you can preview all variables that will be transmitted.',
	'DONT_SEND_STATISTICS'		=> 'Return to the ACP if you do not wish to send statistical information to VictoriaPark.io.',
	...
	'FAIL_SEND_STATISTICS'		=> 'VictoriaPark.io was unable to send statistics',
));
...
$lang = array_merge($lang, array(
	...
	'LOG_INSTALL_CONVERTED'	=> '<strong>Converted from %1$s to VictoriaPark.io %2$s</strong>',
	'LOG_INSTALL_INSTALLED'	=> '<strong>Installed VictoriaPark.io %s</strong>',
	...
	'LOG_UPDATE_PHPBB'		=> '<strong>Updated VictoriaPark.io from version %1$s to version %2$s</strong>',
