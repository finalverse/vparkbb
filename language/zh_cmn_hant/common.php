...
$lang = array_merge($lang, array(
	// Notes from the Translations Manager about your language pack:
	// Please don't use JS code to open the TRANSLATION_INFO with a new tab/window.
	// https://www.js-craft.io/blog/window-open-and-target_blank-have-a-security-vulnerability/
	//'TRANSLATION_INFO'  => '正體中文語系由 <a href="http://phpbb-tw.net/" onclick="window.open(this.href);return false;"> <strong>竹貓星球</strong> </a> 維護製作',
	'TRANSLATION_INFO'  => '正體中文語系由 <a href="https://phpbb-tw.net/" target="_blank" rel="noopener noreferrer"><strong>竹貓星球</strong></a> 維護製作',
	'DIRECTION'			=> 'ltr',
	...
	'ACP'   => '管理員控制台',
	'ACP_SHORT'						=> 'ACP',
	'ACTIVATION_ALREADY_SENT'		=> '啟動電子郵件已傳送至您的電子郵件地址。您可以在 24 小時後重試。如果您在啟動帳號時仍然遇到問題，請聯絡討論區管理員。',
	'ACTIVE'    => '啟用',
	...
	'HOURS' => '小時',
	'HOME'  => '首頁',
	'HTTP_HANDLER_NOT_FOUND'		=> '由於 cURL PHP 擴充功能和 allow_url_fopen PHP ini 設定已被停用且找不到其他 HTTP 處理程序，因此無法完成該操作。',
	...
	'ROUTE_NOT_FOUND'				=> '找不到請求的路徑「%s」。',
	'ROUTE_INVALID_MISSING_PARAMS'	=> '為路徑「%s」傳遞的參數無效或丟失。',
