...
$lang = array_merge($lang, array(
	...
	'PRIVACY_POLICY'		=> '這個隱私權保護政策說明「%1$s」以及其相關網站（以下以「我們」、「我們的」、「%1$s」、「%2$s」代表）如何處理當會員使用本服務時收集到的個人資料（以下以「您的個人資料」、「個人資料」代表）。
	<br><br>
	我們使用兩種方式來收集您的個人資料。第一，當瀏覽「%1$s」時，系統會產生一些 Cookies，這些小型的文字檔案會儲存在您的電腦的網頁瀏覽器暫存資料夾裡，用於儲存工作階段資訊並提升您的使用體驗。
	<br><br>
	您的帳號的主要資訊為：一個獨特的識別名稱（以下以「您的會員名稱」代表），一個讓您登入到您的帳號的個人密碼（以下以「您的密碼」代表）以及一個有效的個人電子郵件位址（以下以「您的電子郵件」代表）。在「%1$s」中，您的帳號所包含的個人資料是由這個網站所在國家或地域的資料保護法所保護。
	<br><br>
	您的密碼已經（單向雜湊演算法）加密處理過，因此它是安全的。但是，我們建議您不要在多個網站重複使用相同的密碼。您的密碼是讓您在「%1$s」存取以及使用您的帳號的方法，所以，請您務必要小心保護它。此外，不論在何種情況下「%1$s」或是任何第三方公司的任何人都不會跟您索取您的密碼。
	',
));
