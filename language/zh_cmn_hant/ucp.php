...
$lang = array_merge($lang, array(
		'TERMS_OF_USE_CONTENT'	=> '訪問 “%1$s”（以下簡稱“我們”或“%1$s”）即表示您同意遵守以下條款。若您不同意，請停止訪問或使用本網站。我們可能不時更新本條款，更新後您繼續使用即視為接受更新後的條款。<br>
	<br>
	您不得發佈任何違法、侮辱、誹謗、仇恨、騷擾、暴力、色情或其他可能違反適用法律法規的內容。我們有權在不另行通知的情況下，對相關內容採取刪除、編輯、移動、鎖定主題、限制帳號等管理措施。<br>
	<br>
	為維護社區安全與秩序，我們會記錄與發文相關的必要技術資訊（如 IP 位址與時間）。如法律法規要求，或為保護社區與用戶權益，我們可能依法配合提供必要資訊。<br>
	<br>
	您提交的內容版權歸原作者所有；您授權 “%1$s” 在論壇範圍內進行展示、存檔與合理管理。若您認為內容侵權或違規，請透過「聯絡我們」渠道提交說明，我們將按流程處理。
	',

	'PRIVACY_POLICY'		=> '本隱私權政策說明 “%1$s”（以下簡稱“我們”）如何收集、使用和保護您的資訊。<br>
	<br>
	我們會在您註冊和使用論壇時收集必要資訊，例如用戶名、密碼雜湊、電子郵件地址、發文內容、站內操作日誌及與安全相關的技術資訊（如 IP 位址、裝置與瀏覽器資訊）。<br>
	<br>
	我們使用 Cookie 與工作階段資料以維持登入狀態、保存偏好設定、記錄已讀主題並提升使用體驗。您可以在瀏覽器中管理 Cookie，但禁用後部分功能可能無法正常使用。<br>
	<br>
	我們僅在提供論壇服務、帳號安全、內容審核、反垃圾與統計分析所必需的範圍內使用您的資訊。除法律法規要求、執法協助或保護社區與用戶合法權益外，我們不會向無關第三方出售或披露您的個人資訊。<br>
	<br>
	您可以在用戶控制面板中修改部分個人資料；如需申請帳號註銷或資料處理協助，請透過「聯絡我們」與管理員聯繫。我們將根據適用法律與營運需要保留必要資料。
	',
));
...
$lang = array_merge($lang, array(
	...
	'BOARD_DATE_FORMAT_EXPLAIN'	=> '語法使用與 PHP <a href="https://www.php.net/manual/datetime.format.php">日期函數</a>相同的格式。',
