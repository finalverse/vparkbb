...
$lang = array_merge($lang, array(
	'ACP_BACKUP_EXPLAIN'	=> '您可以利用備份來保存您所有的 VictoriaPark.io 相關資料。生成的檔案將儲存在您的 <samp>store/</samp> 資料夾內。依照您的伺服器組態，您或許能夠在壓縮檔案時加入一個編號。',
	'ACP_RESTORE_EXPLAIN'	=> '這將會從已儲存的檔案中完全還原所有的 VictoriaPark.io 資料表，假如您的伺服器支援 gzip 或 bzip2 ，那麼您可以使用它們來壓縮 (或自動解壓縮) 純文字檔案。<strong>警告！</strong> 這將會覆蓋所有已存在的資料。在還原時會佔用較長的處理時間，請不要移動任何的頁面直到完成。備份檔會儲存於 <samp>store/</samp> 資料夾內得以產生 VictoriaPark.io 的備份功能。還原的備份檔，如果不是由系統所建立，那麼可能無法正常運作。',
