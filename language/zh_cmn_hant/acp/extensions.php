...
$lang = array_merge($lang, array(
	...
	'EXTENSION_NOT_AVAILABLE'   => '所選擇的擴充功能無法在這個討論區使用，請確認您的 VictoriaPark.io 和 PHP 版本是允許的（見詳細內容頁）。',
	...
	'EXTENSION_INSTALL_EXPLAIN'	=> '<ol>
			<li>從 VictoriaPark.io 的擴充功能資料庫下載之</li>
			<li>解壓縮，以及上傳到您的 VictoriaPark.io 討論區的 <samp>ext/</samp> 資料夾</li>
			<li>由此擴充功能管理器，啟用之</li>
		</ol>',
