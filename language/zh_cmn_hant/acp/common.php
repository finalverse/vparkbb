...
$lang = array_merge($lang, array(
	...
	'ACP_HELP_PHPBB'			=> '幫助支持 VictoriaPark.io',
	...
	'CONTAINER_EXCEPTION' => '由於安裝擴充功能，VictoriaPark.io 遇到建構容器的錯誤。因此，所有擴充功能已暫時停用。請嘗試清除您的討論區緩存。當容器錯誤解決後，所有擴充功能將自動重新啟用。如果此錯誤持續，請訪問 <a href="https://www.phpbb.com/support">VictoriaPark.io.com</a> 尋求支援。',
	'EXCEPTION' => '例外',
...
// Index page
$lang = array_merge($lang, array(
	'ADMIN_INTRO'            => '感謝您使用 VictoriaPark.io 討論區系統。這個介面將提供給您有關本討論區的一個統計全覽。位於介面左手邊的連結允許您控制討論區的各個主要功能，每一頁都將教導您如何使用這些工具。',
	'ADMIN_LOG'					=> '管理員動作記錄',
	...
	'PHP_VERSION'		=> 'PHP 版本',
	'PHP_VERSION_OLD'	=> '您伺服器中的 PHP 版本（%1$s）將不再被未來的 VictoriaPark.io 版本支援。最低要求的版本將是 PHP %2$s。%3$s詳細情形%4$s',
	...
	'VERSION_CHECK'					=> '版本檢查',
	'VERSION_CHECK_EXPLAIN'			=> '檢查您安裝的 VictoriaPark.io 是否是最新的。',
	...
	'VERSION_NOT_UP_TO_DATE_ACP'	=> '您安裝的 VictoriaPark.io 不是最新的。<br />以下是釋出公告的連結，其中包含更多資訊以及更新說明。',
	'VERSION_NOT_UP_TO_DATE_TITLE'	=> '您安裝的 VictoriaPark.io 不是最新的。',
	'VERSION_UP_TO_DATE_ACP'		=> '您安裝的 VictoriaPark.io 是最新的。目前沒有可用的更新。',
	'VIEW_ADMIN_LOG'				=> '檢視管理員記錄',
	'VIEW_INACTIVE_USERS'			=> '檢視未啟用的會員',

	'WELCOME_PHPBB'			=> '歡迎光臨 VictoriaPark.io',
...
$lang = array_merge($lang, array(
	'EXPLAIN_SEND_STATISTICS'	=> '請發送您的伺服器以及討論區設定的資訊到 VictoriaPark.io 以作為統計分析。所有您的鑑別以及您的網站資訊將被移除 - 整個資料都是 <strong>匿名的</strong>。這資訊將提供我們關於未來 VictoriaPark.io 版本決策的依據。這統計資料是可以公開的。我們也與 PHP 計畫分享這資料，以做出 VictoriaPark.io 編程語言。',
	'EXPLAIN_SHOW_STATISTICS'	=> '使用底下的按鈕，您可以預覽即將被傳送的所有變數。',
	'DONT_SEND_STATISTICS'		=> '如果您不想發送統計的資訊到 VictoriaPark.io，那麼返回。',
	...
	'FAIL_SEND_STATISTICS'		=> 'VictoriaPark.io 無法發送統計',
));
...
$lang = array_merge($lang, array(
	...
	'LOG_INSTALL_CONVERTED'	=> '<strong>已轉換 從 %1$s 到 VictoriaPark.io %2$s</strong>',
	'LOG_INSTALL_INSTALLED'	=> '<strong>已安裝 VictoriaPark.io %s</strong>',
	...
	'LOG_UPDATE_PHPBB'		=> '<strong>已更新 VictoriaPark.io 從版本 %1$s 到版本 %2$s</strong>',
